                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    <div class="navbar-nav ml-auto align-items-center">
                        ...
                        <a class="nav-link bg-success text-white ml-2 px-3 py-2" style="border-radius: 8px; box-shadow: 0 4px 15px rgba(16, 185, 129, 0.3);" href="my-profile.php">
                            <i class="fa-regular fa-user mr-1"></i> My Profile
                        </a>
        ...
        <div class="row">
            ...
            <div class="col-lg-2 col-md-6 col-6 mb-4">
                ...
                <ul style="list-style: none; padding: 0; margin: 0;">
                    <li style="margin-bottom: 12px;"><a href="register-dashboard.php" style="color: #94a3b8; text-decoration: none; font-size: 14px; transition: all 0.2s;" onmouseover="this.style.color='#10b981';this.style.paddingLeft='5px'" onmouseout="this.style.color='#94a3b8';this.style.paddingLeft='0'">Dashboard</a></li>
                    <li style="margin-bottom: 12px;"><a href="meal-plans.php" style="color: #94a3b8; text-decoration: none; font-size: 14px; transition: all 0.2s;" onmouseover="this.style.color='#10b981';this.style.paddingLeft='5px'" onmouseout="this.style.color='#94a3b8';this.style.paddingLeft='0'">Meal Plans</a></li>
            ...
            <div class="col-lg-2 col-md-6 col-6 mb-4">
                <h6 style="font-family: 'Outfit', sans-serif; font-weight: 700; color: #f1f5f9; margin-bottom: 20px; font-size: 16px;">Support</h6>
                <ul style="list-style: none; padding: 0; margin: 0;">
                    <li style="margin-bottom: 12px;"><a href="support.php" style="color: #94a3b8; text-decoration: none; font-size: 14px; transition: all 0.2s;" onmouseover="this.style.color='#10b981';this.style.paddingLeft='5px'" onmouseout="this.style.color='#94a3b8';this.style.paddingLeft='0'">Help Center</a></li>
                    <li style="margin-bottom: 12px;"><a href="Sub-tips.php" style="color: #94a3b8; text-decoration: none; font-size: 14px; transition: all 0.2s;" onmouseover="this.style.color='#10b981';this.style.paddingLeft='5px'" onmouseout="this.style.color='#94a3b8';this.style.paddingLeft='0'">Wellness Tips</a></li>
                    <li style="margin-bottom: 12px;"><a href="manage-plans.php" style="color: #94a3b8; text-decoration: none; font-size: 14px; transition: all 0.2s;" onmouseover="this.style.color='#10b981';this.style.paddingLeft='5px'" onmouseout="this.style.color='#94a3b8';this.style.paddingLeft='0'">Manage Plans</a></li>
                    <li><a href="#" style="color: #94a3b8; text-decoration: none; font-size: 14px; transition: all 0.2s;" onmouseover="this.style.color='#10b981';this.style.paddingLeft='5px'" onmouseout="this.style.color='#94a3b8';this.style.paddingLeft='0'">FAQ</a></li>
                </ul>
            </div>
            <div class="col-lg-4 col-md-6 mb-4">
