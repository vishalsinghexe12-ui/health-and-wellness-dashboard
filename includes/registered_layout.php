...
<!-- Register Navigation Bar -->
    <div class="container-fluid">
            ...
            <a class="navbar-brand" href="../user/register-dashboard.php"><img class="guest-nav-image" src="../images/logo.jpeg"/><span class="guest-navbar-heading pt-5" id="navbar-name">Health & Wellness</span></a>
