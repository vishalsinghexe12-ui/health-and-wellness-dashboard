<?php
$title = "Change Password - Health & Wellness";
            ...
            <div class="card shadow-lg border-0" style="border-radius: 20px; overflow: hidden;">
                ...
                <div class="card-body p-4 p-md-5">
                    ...
                    <div class="text-center mb-4">
                        ...
                        <h3 style="font-family: 'Outfit', sans-serif; font-weight: 800; color: #111827;">Change Password</h3>
                        <p class="text-muted" style="font-size: 15px;">Update your password to keep your account secure</p>
                    </div>
                    ...
                    <form action="../change_password_process.php" method="POST" id="changePasswordForm">
                        <input type="hidden" name="panel" value="user">
                        ...
                        <div class="text-center mt-3">
                            <a href="my-profile.php" style="color: #059669; font-weight: 600; text-decoration: none; font-family: 'Outfit', sans-serif;">
