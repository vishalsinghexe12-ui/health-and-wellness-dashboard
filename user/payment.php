                      ...
                      <div class="tab-pane fade show active" id="pills-card" role="tabpanel">
                          <form id="paymentForm">
                              <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" placeholder="John Doe" required style="border-radius: 8px; padding: 22px 15px;">
                              </div>
                              <div class="form-group">
                                  <label class="text-muted font-weight-bold">Card Number</label>
                                  <div class="input-group">
                                      <input type="text" class="form-control" placeholder="0000 0000 0000 0000" required style="border-radius: 8px 0 0 8px; padding: 22px 15px;">
                              ...
                              <div class="row">
                                  <div class="col-6">
                                      <div class="form-group">
                                          ...
                                          <input type="text" class="form-control" placeholder="MM/YY" required style="border-radius: 8px; padding: 22px 15px;">
                                      </div>
                                  </div>
                                  <div class="col-6">
                                      <div class="form-group">
                                          <label class="text-muted font-weight-bold">CVV</label>
                                          <input type="password" class="form-control" placeholder="•••" required style="border-radius: 8px; padding: 22px 15px;">
                                      </div>
                                  </div>
                              </div>
                              <button type="button" class="btn btn-success btn-lg btn-block mt-4" style="border-radius: 8px;" onclick="processPayment()">
                      ...
                      <div class="tab-pane fade" id="pills-upi" role="tabpanel">
                          <form>
                              <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" placeholder="username@upi" required style="border-radius: 8px; padding: 22px 15px;">
                              </div>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content text-center p-5">
      ...
      <div id="successState" style="display:none;">
          ...
          <a href="register-dashboard.php" class="btn btn-success btn-block" style="border-radius:8px;">Go to Dashboard</a>
      </div>
    </div>
  </div>
</div>
...
function processPayment() {
    ...
    // Simulate 2 seconds of payment processing delay
    setTimeout(function() {
